  ...
  return (
    <>
      <Flex w={"100%"} h={"max-content"} justifyContent={"center"} alignItems={"center"}>
        <Grid templateColumns='repeat(5, 1fr)' w={"80%"} h={"fit-content"} mt={"40px"} gap={6}>
          {data.map((product) => (
            ...
            <Box>
              ...
              <Box p={4}>
                ...
                <Box display={"flex"} justifyContent={"space-between"} mt={4} borderTop={"2px solid black"} >
                  <Button as={RouterLink} to={`/products/${product.id}`} mt={2} bg={"#ffb747"} _hover={{boxShadow: "4px 4px 0px 0px rgba(0, 0, 0, 1)",}}>
                    Details
                  </Button>
                  <Button as={RouterLink} to={`/`} mt={2} bg={"#ffb747"} _hover={{boxShadow: "4px 4px 0px 0px rgba(0, 0, 0, 1)",}}>
                    Add to cart
                  </Button>
                </Box>
              </Box>
